...
yes | apt install python3-pip git build-essential libssl-dev libffi-dev python3-dev libpq-dev libwebp-dev libjpeg-dev libtiff-dev libopenjp2-7-dev zlib1g-dev knot-dnsutils resolvconf protobuf-compiler libprotobuf-dev
